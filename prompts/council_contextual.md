...
- **Context is King**: A message asking for OTP is SCAM if unsolicited, but SAFE if user just asked "send code".
- **Initiation**: Identifying who started the interaction is the #1 predictor of legitimacy.
